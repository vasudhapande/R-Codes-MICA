...
input_csv.df <- read.csv(file="/Users/vasudhapande/Documents/MICA/Term 4/AMMA/binary.csv")
...
csv_file <- read.table(file="/Users/vasudhapande/Documents/MICA/Term 4/AMMA/binary.csv",
                                header = TRUE, 
                                sep = ',')

## Read a Tab Delimited file
input_tabdlmtd.df <- read.table(file="/Users/vasudhapande/Documents/MICA/Term 4/AMMA/tab_delimited_data.txt",
                                header = TRUE, 
                                sep = '\t')
...
input_dollar.df <- read.table(file="/Users/vasudhapande/Documents/MICA/Term 4/AMMA/dollar_delimited_data.txt",
                                header = TRUE, 
                                sep = '$')
...
bank_ins = read.sas7bdat("/Users/vasudhapande/Documents/MICA/Term 4/AMMA/bank_additional_full.sas7bdat")
names(bank_ins)
...
write.csv(tt, "/Users/vasudhapande/Documents/MICA/Term 4/AMMA/mtcars.csv",
          row.names=F
)
